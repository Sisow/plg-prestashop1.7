<form action="{$action}" method="POST" id="payment-form" class="additional-information">
		<div class="form-group row">
			<div class="col-md-12">
				<p>
					Mit giropay zahlen Sie einfach, schnell und sicher im Online-Banking Ihrer teilnehmenden Bank oder Sparkasse. Sie werden direkt zum Online-Banking Ihrer Bank weitergeleitet, wo Sie die �berweisung durch Eingabe von PIN und TAN freigeben.
				</p>
			</div>
		</div>
