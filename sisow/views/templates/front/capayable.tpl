<form action="{$action}" method="POST" id="payment-form" class="additional-information">
	<p>
		Je betaalt de  bestelling in drie gelijke termijnen. De eerste termijn betaal je nu direct via iDEAL. Van In3 ontvang je vervolgens een iDEAL link voor de tweede (dag 30) en derde (dag 60) termijn.
	<p>
